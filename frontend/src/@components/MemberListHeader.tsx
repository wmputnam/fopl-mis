...
const MemberListHeader = ({getAppState,setAppState}:FrontendProps ) => 
{
    ...
    return (
        <div className="member-row--header header" data-testid="member-row--header header">
            ...
            <div className="member-row--email" data-testid="member-row--email">Email</div>
            <div className="member-row--mmb" data-testid="member-row--mmb">MMB</div>
            <div className="member-row--tools" data-testid="member-row--tools"><button className="member-row--header--new-btn" data-testid="member-row--header--new-btn" title="Add new member" onClick={handleNewClick}>+</button></div>
        </div>
    );
}
