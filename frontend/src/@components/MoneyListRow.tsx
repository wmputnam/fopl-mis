...
const RemittancesListRow = ({ date, amount, memo }: Remittance): any => {
    return (
        <div className="remits-row row" data-testid="remits-row" >
            <div className="remits-row--date col" data-testid="remits-row--date">{formatDate(date)} </div>
            <div className="remits-row--memo col" data-testid="remits-row--memo">{memo}</div>
            <div className="remits-row--amount col" data-testid="remits-row--amount">{amount}</div>
        </div>
    );
}
